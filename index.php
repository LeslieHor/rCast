				...
				<accordion-group ng-repeat="podcast in podcasts">
					...
					<accordion close-others="false">
						<accordion-group ng-repeat="episode in podcast.episodes">
							<accordion-heading>
								{{ episode.title }} <span class="label label-default">{{ episode.status | intToStatus }}</span>
							</accordion-heading>
							<div>
								<div class="download"><a href="#" ng-click="download_episode(podcast, episode)">DOWNLOAD</a></div>
								<div class="play"><a href="#" ng-click="play_episode(podcast, episode)">PLAY</a></div>
								<div class="save_time"><a href="#" ng-click="save_time(podcast, episode)">Save Time</a></div>
								...
								<div class="publish_date">{{ episode.publish_date }}</div>
							</div>
						</accordion-group>
					</accordion>
				</accordion-group>
				...
				<!-- Floating player controls at the botttom of the page -->
					<div class="player_container">
						...
						<div id="player_information" class="player_information">
							<div class="well well-sm">{{ current_podcast}} - {{ current_track }}  {{ current_time | secondsToDateTime | date:'H:mm:ss'  }} / {{ total_time | secondsToDateTime | date:'H:mm:ss' }}</div>
						</div>
